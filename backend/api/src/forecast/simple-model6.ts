...
// const NycDataSet = require('./NycDataSet');
import tf from '@tensorflow/tfjs-node';
import {NycDataSet} from './NycDataSet.js';
...
function createFeatures(monthNumbers) {
    ...
    for (let month of monthNumbers) {
        ...
        console.log('createFeatures month:', month);
        console.log('createFeatures monthInYear:', monthInYear);
    ...
    console.log('createFeatures features',features);
    console.log('createFeatures features length',features.length);

    console.log('\n=== createFeatures === END === ');

    const testData = [trainMonthsX, [trainMonthsX.length, 1]]
    console.log('createFeatures testData',testData);
    console.log('\n=== createFeatures === END === ');
...
async function trainSeasonalModel() {
    ...
    return {
        ...
        nextYearPredictions: nextYearResults,
